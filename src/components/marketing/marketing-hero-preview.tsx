...
export function MarketingHeroPreview() {
  ...
  return (
    <div className="relative mx-auto mt-10 max-w-sm sm:mt-12 sm:max-w-md lg:max-w-lg">
      <div
        aria-hidden
        className="absolute -left-6 top-8 h-28 w-28 rounded-full bg-primary/20 blur-3xl sm:-left-10"
      />
      <div
        aria-hidden
        className="absolute -right-4 bottom-4 h-24 w-24 rounded-full bg-emerald-400/20 blur-3xl"
      />
      ...
      <div className="marketing-float relative rounded-2xl border border-border/80 bg-card/90 p-4 shadow-xl shadow-primary/10 backdrop-blur-sm sm:p-5">
        ...
        <div className="mt-4 flex items-end justify-between gap-4">
          <div>
            ...
            <p className="text-4xl font-bold tabular-nums text-primary">87</p>
          </div>
