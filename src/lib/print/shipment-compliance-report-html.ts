...
export function buildShipmentComplianceReportHtml(input: ShipmentComplianceReportInput): string {
  ...
  return `<article class="report">
    ...
    <section>
      ...
      <p class="section-intro">${escapeHtml(t.summaryIntro)}</p>
    ...
    <section>
      ...
      <p class="section-intro">${escapeHtml(t.readinessIntro)}</p>
    ...
    <section>
      ...
      <p class="section-intro">${escapeHtml(t.scoreBreakdownIntro)}</p>
      <table class="data-table">
        <tbody>
